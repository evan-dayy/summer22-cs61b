...
public class Main {
    ...
    static final File f = new File(".capers/story.txt");
    ...
    public static void setupPersistence() {
        // FIXME
        if(!CAPERS_FOLDER.exists()){ // java.io.files libraries
            CAPERS_FOLDER.mkdir();
        }
        if(!f.exists()) {
    ...
    public static void writeStory(String[] args) {
        ...
        // FIXME
        String prevString = Utils.readContentsAsString(f);
        Utils.writeContents(f, prevString + args[1] + "\n");
    ...
    public static void celebrateBirthday(String[] args) {
        ...
        // FIXME
        Dog birthDog = Dog.fromFile(args[1]);
