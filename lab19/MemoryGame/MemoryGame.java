...
public class MemoryGame {
    ...
    public String generateRandomString(int n) {
        ...
        String rt = "";
        for(int i = 0; i < n; i ++){
            int charNum = this.rand.nextInt(26);
            rt = rt + CHARACTERS[charNum];
        }
        return rt;
    }
    ...
    public void startGame() {
        ...
        while (!gameOver) {
            ...
            StdDraw.pause(1000);
            StdDraw.clear();
            String displayString = generateRandomString(round);
            StdDraw.pause(500);
            flashSequence(displayString);
            drawFrame("What is the flash sequence :) !!");
            StdDraw.clear();
            String userString = solicitNCharsInput(round);
            if(Objects.equals(userString, displayString)){
                continue;
            } else {
